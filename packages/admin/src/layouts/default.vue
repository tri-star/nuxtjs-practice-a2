...
<template>
  <!-- TODO: 背景色の変数化 -->
  <div class="relative flex flex-col w-full h-full items-start bg-outlined-disabled overflow-hidden">
    <div
      class="sticky top-0 flex w-full px-header-space-x py-header-space-y gap-header-gap items-center bg-header-background backdrop-blur-md"
    >
    ...
    <div class="flex items-start flex-1 w-full h-full">
      <SideMenu />
      <main class="flex p-2 flex-col items-start gap-5 flex-1 w-full h-full overflow-y-auto">
